import 'package:crypto_app/utils/colors/hex_color_utils.dart';
...
class AppThemeUtils {
  ...
  static TextStyle smallSize({Color color, double fontSize = 14}) =>
      GoogleFonts.ubuntu(
          decoration: TextDecoration.none, fontSize: fontSize, color: color);
  static Color colorPrimaryClient = HexColor("D4AF37"); //"00A4D5");
  static Color colorPrimaryLight = HexColor("D4AF37"); //"00A4
  static Color colorPrimary = HexColor("D4AF37"); //"00A4D5");
  static Color colorPrimaryDark = HexColor("D4AF37"); //"00A4D5");
